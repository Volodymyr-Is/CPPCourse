// 7. В відомості зберігається інформація про пропуски занять студентами: ПІБ, факультет, група, кількість пропусків.
// Вивести список із 10 студентів із найбільшою кількістю пропусків.
